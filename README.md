...
- **Heap Exploitation** - Explora vulnerabilidades no gerenciador de memória dinâmica ✅
  ...
  - **House of Rabbit**: Corrompe tcache através de largebins (glibc 2.31+)
  - **House of Husk**: Explora printf hooks via tcache
  - **House of Kiwi**: Para Windows/outros allocators
  - **House of Muney**: Foco em alinhamento e overflow de metadata
  - **House of Bananas**: Para ambientes com PAC (Pointer Authentication)
  - **House of Emma**: Explora _dl_fini e rtld_global
  - **House of Botcake**: Dupla liberação (double free) em tcache
  - **House of Lore Modern**: Atualizações para glibc 2.31+
