...
Achei mais conveniente abordar melhor syscalls em [Buffer Overflow - Shellcode](/docs/pwning/bof/2-3-bof-shellcode), para já conectar com o ataque a ser feito. Porém, syscalls são basicamente funções que o Sistema Operacional possui, facilitanto o uso de recursos do sistema (escrever, ler, conectar, sair, etc).
